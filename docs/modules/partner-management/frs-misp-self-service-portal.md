...
8. Partner ID serves as search criteria to update the record in the database
...
16. Input parameters must be present as mentioned below:
    * Partner ID - Mandatory
    * Policy ID - Mandatory
