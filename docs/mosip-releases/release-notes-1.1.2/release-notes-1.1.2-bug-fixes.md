# Release Notes 1.1.2 Bug Fixes

This document contains the bugs that were fixed as part of MOSIP 1.1.2 release.

| JIRA ID | Summary | Module |
| :--- | :--- | :--- |
| [MOSIP-9830](https://mosip.atlassian.net/browse/MOSIP-9830) | Getting full name is displayed in dollar as $fullName\_eng, under email received | Resident Services |
...
| [MOSIP-9703](https://mosip.atlassian.net/browse/MOSIP-9703) | 1.1.2:  Registration Client Initial Sync Failure \(ERROR - RESPONSE\_SIGNATURE\_VALIDATION \) | Registration Processor |
...
| [MOSIP-8172](https://mosip.atlassian.net/browse/MOSIP-8172) | Admin\_UpdateRegCenter\_Invalid\_locationCode\_blank | Admin Services |
