...
| [MOSIP-8697](https://mosip.atlassian.net/browse/MOSIP-8697) | ENVIssue- Packet is not moving post-SECUREZONE\_NOTIFICATION stage. | Registration Processor |
...
| [MOSIP-8327](https://mosip.atlassian.net/browse/MOSIP-8327) | ENV ISSUE- Error at PRINT\_SERVICE stage. | Registration Processor |
...
| [MOSIP-8306](https://mosip.atlassian.net/browse/MOSIP-8306) | Admin\_GetLeafZones\_forNoZoneMap  Error to be corrected under response | Admin |
