...
* [UI Specification for Registration Client](../registration-client/ui-specification-for-registration-client.md)
* [UI Specification for Pre-registration](../pre-registration/ui-specification-for-pre-registration.md)

## Relationship between ID Schema, ID Object & UI Specification

![](../../.gitbook/assets/id_schema_concept.png)
